function  f2p = imshow3D( Img, disprange )
...
Btn2hand = uicontrol('Style', 'pushbutton','Position', Btn2_Pos,'String','Select FoR', 'FontSize', BtnSz, 'Callback' , @SelectRef);
...
% -=< Window and level to range conversion >=-
    ...
    function f2p = SelectRef(hObj, event)
	close all;
    end
